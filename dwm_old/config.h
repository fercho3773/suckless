...
#define SHCMD(cmd) { .v = (const char*[]){ "/bin/sh", "-c", cmd, NULL } } /* spawn shell in pre dwm-5.0*/
...
/* Commands */
#define killdwm     "killall dwmblocks dwm dunst pipewire pipewire-pulse wireplumber xclip xcompmgr"
